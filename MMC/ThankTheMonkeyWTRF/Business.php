 ...
 */
    ...
    class BusinessPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), 'business.mediaPartnerId = 1'));
        }
        ...
        protected function AddFieldColumns($grid)
        {
            ...
            $editColumn->SetGenerationImageThumbnails(
                'imageName',
                '',
                Delegate::CreateFromMethod($this, 'imageName_Thumbnail_GenerateFileName_inline_edit'),
            ...
            $editColumn->SetGenerationImageThumbnails(
                'imageName',
                '',
                Delegate::CreateFromMethod($this, 'imageName_Thumbnail_GenerateFileName_inline_insert'),
                new ImageFitByHeightResizeFilter(100)
            );
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            //
            // View column for mediaPartnerId field
            //
            $column = new TextViewColumn('mediaPartnerId', 'MediaPartnerId', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddEditColumns($grid)
        {
            ...
            $editColumn->SetGenerationImageThumbnails(
                'imageName',
                '',
                Delegate::CreateFromMethod($this, 'imageName_Thumbnail_GenerateFileName_edit'),
                new ImageFitByHeightResizeFilter(100)
            );
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            //
            $editor = new TextEdit('mediapartnerid_edit');
            $editColumn = new CustomEditColumn('MediaPartnerId', 'mediaPartnerId', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        }
        ...
        protected function AddInsertColumns($grid)
        {
            ...
            $editColumn->SetGenerationImageThumbnails(
                'imageName',
                '',
                Delegate::CreateFromMethod($this, 'imageName_Thumbnail_GenerateFileName_insert'),
                new ImageFitByHeightResizeFilter(100)
            );
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
        ...
        public function imageName_Thumbnail_GenerateFileName_inline_edit(&$filepath, &$handled, $original_file_name, $original_file_extension, $file_size)
        {
        ...
        public function imageName_Thumbnail_GenerateFileName_inline_insert(&$filepath, &$handled, $original_file_name, $original_file_extension, $file_size)
        {
        $targetFolder = FormatDatasetFieldsTemplate($this->GetDataset(), '');
        FileUtils::ForceDirectories($targetFolder);
        ...
        public function imageName_Thumbnail_GenerateFileName_edit(&$filepath, &$handled, $original_file_name, $original_file_extension, $file_size)
        {
        $targetFolder = FormatDatasetFieldsTemplate($this->GetDataset(), '');
        FileUtils::ForceDirectories($targetFolder);
        ...
        public function imageName_Thumbnail_GenerateFileName_insert(&$filepath, &$handled, $original_file_name, $original_file_extension, $file_size)
        {
        $targetFolder = FormatDatasetFieldsTemplate($this->GetDataset(), '');
        FileUtils::ForceDirectories($targetFolder);
