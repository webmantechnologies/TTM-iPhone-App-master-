 ...
 */
    ...
    class WTRF_Business_TypesPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $selectQuery = 'SELECT * from businesstype where mediaPartnerId = 1';
            $insertQuery = array();
            $updateQuery = array();
            $deleteQuery = array();
            $this->dataset = new QueryDataset(
              ...
              $selectQuery, $insertQuery, $updateQuery, $deleteQuery, 'WTRF Business Types');
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('WTRF_Business_Typesssearch', $this->dataset,
                array('primaryKey', 'name', 'mediaPartnerId'),
                array($this->RenderText('PrimaryKey'), $this->RenderText('Name'), $this->RenderText('MediaPartnerId')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('WTRF_Business_Typesasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('mediaPartnerId', $this->RenderText('MediaPartnerId')));
        }
        ...
        {
            $result = new Grid($this, $this->dataset, 'WTRF_Business_TypesGrid');
    ...
    try
    {
        $Page = new WTRF_Business_TypesPage("WTRF_Business_Types.php", "WTRF_Business_Types", GetCurrentUserGrantForDataSource("WTRF_Business_Types"), 'UTF-8');
        $Page->SetShortCaption('WTRF Business Types');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('WTRF Business Types');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("WTRF Business Types"));
