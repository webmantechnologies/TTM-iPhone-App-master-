 ...
 */
    ...
    class BusinessTypePage extends Page
    {
        ...
        protected function AddEditColumns($grid)
        {
            ...
            $editColumn = new UploadFileToFolderColumn('ImageName', 'imageName', $editor, $this->dataset, false, false, 'BusinessType');
        ...
        {
        $targetFolder = FormatDatasetFieldsTemplate($this->GetDataset(), 'BusinessType');
