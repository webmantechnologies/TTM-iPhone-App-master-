    ...
    class BusinessPage extends Page
    {
        ...
        public function GetPageList()
        {
            ...
            if (GetCurrentUserGrantForDataSource('Business')->HasViewGrant())
                $result->AddPage(new PageLink($this->RenderText('Business'), 'Business.php', $this->RenderText('Business'), $currentPageCaption == $this->RenderText('Business')));
        ...
        protected function CreateGridSearchControl($grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('Businessssearch', $this->dataset,
                array('primaryKey', 'name', 'imageName', 'description', 'website', 'businessType_name', 'marketId_name'),
                array($this->RenderText('PrimaryKey'), $this->RenderText('Name'), $this->RenderText('ImageName'), $this->RenderText('Description'), $this->RenderText('Website'), $this->RenderText('BusinessType'), $this->RenderText('MarketId')),
                array(
        ...
        protected function AddFieldColumns($grid)
        {
            ...
            $column->SetSourcePrefix('Business/');
