                        ...
                        <tr>
                            <td>
                                <button
                                    ...
                                    onclick="<?php echo 'WriteWYSIWYGValuesToTheirTextAreas(); if (ValidateSimpleForm($(\'#insertform\'), $(\'ul.editing-error-box\'), true)) { document.insertform.submit(); } return false;'; ?>
"
                                ...
                                <div class="dropdown-button-menu">
                                    <ul id="submit-button-list" style="display: none;">
                                        ...
                                        <li data-value="saveinsert"><?php echo $this->_tpl_vars['Captions']->GetMessageString('SaveAndInsert'); ?>
</li>
